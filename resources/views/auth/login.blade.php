...
@section('page-styles')
<link rel="stylesheet" type="text/css" href="{{asset('resources/css/pages/authentication.css')}}">
@endsection
    ...
    <div class="card bg-authentication mb-0">
      <div class="row m-0">
        ...
        <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
          <img class="img-fluid" src="{{asset('resources/images/pages/login.png')}}" alt="branding logo">
        </div>
      </div>
    </div>
  </div>
